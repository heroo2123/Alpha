...
The [engineering checkpoint](docs/PRODUCTION_CHECKPOINT.md) identifies the actual source SHAs, verification state and release blockers. A working-tree implementation is not release approval.
