...
"""Final all-weather PAPER runtime with immutable retry identities."""
...
FINAL_ALL_PAPER_RUNTIME_V7_VERSION = (
    "weather_all_paper_final_v10_immutable_retry_identity"
)
...
class FinalAllPaperWeatherLiveServiceV7(FinalAllPaperWeatherLiveServiceV6):
    def __init__(self, **kwargs) -> None:
        ...
        self._v7_operator_superseded_settlement = self.settlement
        self._v7_operator_superseded_commands = self.commands
        self.positions = OperatorStatePostReceiptStoreV3(self.db_path)
        self._v7_operator_recovery = self.positions.reconcile_v5_after_restart()
    ...
    async def close(self) -> None:
        await asyncio.gather(
            self._v7_operator_superseded_settlement.close(),
            self._v7_operator_superseded_commands.close(),
