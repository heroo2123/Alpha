...
| R14 | 3A | Dataset provenance and leakage controls | v11/datasets.py; tests/test_v11_datasets.py | PARTIAL: feature/label provenance, fit cutoff, temporal/event/city-day splits and correction guards; 19 tests pass; exact source-label and learner integration pending | NOT VERIFIED / NOT ELIGIBLE / NONE |
| R15 | 3A | Reproducible offline learner and evaluation | v11/datasets.py; weather_calibration_experiment.py | PARTIAL: immutable plan/attempt/failure/holdout-reveal journal tested; bounded learner and comparative evaluation pending | NOT VERIFIED / NOT ELIGIBLE / NONE |
...
| R45 | all | Integrated regression and security acceptance | tests/test_v11_*.py; tests/; requirements-dev.txt | PARTIAL: baseline 2336 passed; 137 new targeted tests passed; broader V11 acceptance and independent review pending | NOT VERIFIED / NOT ELIGIBLE / NONE |
