...
| R45 | all | Integrated regression and security acceptance | tests/test_v11_*.py; tests/; requirements-dev.txt | PARTIAL: baseline 2336 passed; 87 new targeted tests passed; broader V11 acceptance and independent review pending | NOT VERIFIED / NOT ELIGIBLE / NONE |
