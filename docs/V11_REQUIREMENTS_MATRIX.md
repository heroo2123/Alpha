...
|---|---|---|---|---|---|
| R00 | 0 | Input/control identity | docs/V11_INPUT_MANIFEST.json; docs/V11_V10_FORENSIC_BASELINE.md | PARTIAL: input hashes, source/tree and 221 deployed files verified; runtime metadata versions match pins; protected runtime remains blocked | NOT VERIFIED / NOT ELIGIBLE / NONE |
| R01 | 0 | Consistent snapshot and V10 forensics | tools/v11_snapshot.py; v11/forensics.py; tests/test_v11_snapshot_forensics.py | PARTIAL: 13 synthetic snapshot/forensic tests pass; real V10 snapshot and full baseline analysis blocked | NOT VERIFIED / NOT ELIGIBLE / NONE |
...
| R45 | all | Integrated regression and security acceptance | tests/test_v11_*.py; tests/; requirements-dev.txt | PARTIAL: baseline 2336 passed; 53 new targeted tests passed; broader V11 acceptance and independent review pending | NOT VERIFIED / NOT ELIGIBLE / NONE |
