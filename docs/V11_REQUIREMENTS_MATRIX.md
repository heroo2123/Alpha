...
| R01 | 0 | Consistent snapshot and V10 forensics | tools/v11_snapshot.py; v11/forensics.py; tests/test_v11_snapshot_forensics.py | PARTIAL: 8 synthetic snapshot/forensic tests pass; real V10 snapshot and full baseline analysis blocked | NOT VERIFIED / NOT ELIGIBLE / NONE |
...
| R45 | all | Integrated regression and security acceptance | tests/test_v11_*.py; tests/; requirements-dev.txt | PARTIAL: baseline 2336 passed; 48 new targeted tests passed; broader V11 acceptance and independent review pending | NOT VERIFIED / NOT ELIGIBLE / NONE |
