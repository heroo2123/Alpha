...
def test_dataset_bridge_preserves_exact_recomputed_label_provenance(tmp_path):
...
def test_dataset_bridge_rejects_stored_authority_shortcut_even_with_plausible_record():
    report = {
        "version": WEATHER_CALIBRATION_READER_VERSION,
        "read_only_database": True,
        "source_recomputed": True,
        "stored_authorized_json_used_as_authority": True,
