...
from polymarket_scanner.weather_only_live_paper_all_signals_final_v2 import (
...
def test_final_renderer_targets_final_wrapper():
    ...
    assert FINAL_ALL_PAPER_RUNTIME_V2_VERSION
...
def test_prepare_requires_and_imports_same_final_wrapper():
    ...
    assert "polymarket_scanner/weather_only_live_paper_all_signals_final_v2.py" in text
...
def test_runtime_attestation_targets_same_final_wrapper_and_inventories_it():
    ...
    assert '"weather_only_live_paper_all_signals_final_v2.py"' in text
...
def test_final_acceptance_requires_second_corrective_wrapper_markers():
    ...
    assert "ALL_PAPER_FINAL_V2_WRAPPER_VERSION_MISMATCH" in text
